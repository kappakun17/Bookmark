...
class my_Dialogs_MenuBars(tk.Frame):
    ...
    def create_category_menu(self, title):
        ...
        self.categoryMenu = my_CategoryMenu(category_dialog, title=title)
    ...
    def create_folder_menu(self, title):
        ...
        self.folderMenu = my_FolderMenu(folder_dialog, title=title)
    ...
    def create_bookmark_menu(self, title):
        ...
        self.bookmarkMenu = my_BookmarkMenu(bookmark_dialog, title=title)
    ...
    def open_screen(self,event, key=None, action=None):
        ...
        self.destroy()
        my_Dialogs_Actions(self.master).create_dialog('test')