...
class my_Dialogs_MenuBars(tk.Frame):
    ...
    def create_category_menu(self):
        ...
        self.dialog = self.create_dialog("Category Menu")
        self.categoryMenu = my_CategoryMenu(self.dialog, name=self.name)
    ...
    def create_folder_menu(self):
        self.name = self.json['name']
        self.dialog = self.create_dialog("Folder Menu")
        self.folderMenu = my_FolderMenu(self.dialog, name=self.name)
    ...
    def create_bookmark_menu(self):
        self.name = self.json['name']
        self.dialog = self.create_dialog("Bookmark Menu")
        self.bookmarkMenu = my_BookmarkMenu(self.dialog, title=self.name)
    ...
    def create_settings_menu(self):
        self.name = self.json['name']
        self.dialog = self.create_dialog("Settings Menu")
        self.settingsMenu = my_SettingsMenu(self.dialog, title=self.name)
