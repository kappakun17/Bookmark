...
class my_CategoryMenu(tk.Frame):
    def __init__(self, master=None, cnf={}, name=None, **kw):
        ...
        header_label = tk.Label(self, text=category_name, bg='#E893B1', borderwidth = 0, highlightthickness = 0, relief = "flat", activebackground='#fffdf8', height=2,  font=("HGPｺﾞｼｯｸE", "10", "bold"), foreground='white')
